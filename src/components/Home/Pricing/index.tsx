        ...
        <div className="container">
          ...
          <span
              ...
              className={`mr-4 cursor-pointer text-base font-semibold ${
                  isMonthly ? "pointer-events-none text-primary" : "text-gray-300"
              }`}
          >
            Monthly
          </span>
            <div onClick={() => setIsMonthly(!isMonthly)} className="flex cursor-pointer items-center">
              <div className="relative">
                <div className="h-5 w-14 rounded-full bg-gray-700 shadow-inner"></div>
                <div
                    className={`${
            ...
            <span
                ...
                className={`ml-4 cursor-pointer text-base font-semibold ${
                    isMonthly ? "text-gray-300" : "pointer-events-none text-primary"
                }`}
            >
            Yearly
          </span>
