...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="h-screen relative z-10 overflow-hidden flex items-center justify-center  bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
