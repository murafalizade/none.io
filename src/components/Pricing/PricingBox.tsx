...
const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="bg-gray-dark shadow-two hover:shadow-gray-dark relative z-10 rounded-xs px-8 py-10">
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-[32px] font-bold text-white">
